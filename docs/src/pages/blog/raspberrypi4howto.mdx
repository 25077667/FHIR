...
The default password used throughout is `hey_yoh_what` and this is configured as clear-text in the configuration files to make it even more obvious that it should be changed as part of any hardening. Refer to the [FHIRServerUsersGuide](https://ibm.github.io/FHIR/guides/FHIRServerUsersGuide) for more details.
...
-u 'fhiruser:hey_yoh_what' 'https://localhost:9443/fhir-server/api/v4/Patient' -d '
{
...
```
curl --silent -k -H 'Accept: application/json' -u 'fhiruser:hey_yoh_what' 'https://localhost:9443/fhir-server/api/v4/Patient/041786ad-d6a1-42ea-bf47-4dd8eb08a5fc' | python -m json.tool
```
...
-X PUT \
-H 'Content-Type: application/json' \
-u 'fhiruser:hey_yoh_what' 'https://localhost:9443/fhir-server/api/v4/Patient/041786ad-d6a1-42ea-bf47-4dd8eb08a5fc' -d '
{
    "active": true,
    "gender": "male",
    "id": "041786ad-d6a1-42ea-bf47-4dd8eb08a5fc",
...
```
curl --silent -k -H 'Accept: application/json' -u 'fhiruser:hey_yoh_what' 'https://localhost:9443/fhir-server/api/v4/Patient/041786ad-d6a1-42ea-bf47-4dd8eb08a5fc/_history/1' | python -m json.tool
...
```
curl --silent -k -H 'Accept: application/json' -u 'fhiruser:hey_yoh_what' 'https://localhost:9443/fhir-server/api/v4/Patient/041786ad-d6a1-42ea-bf47-4dd8eb08a5fc/_history' | python -m json.tool
```
